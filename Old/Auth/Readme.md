...
```sh
az acr login -n zuhiddev
docker build -t zuhiddev.azurecr.io/auth:latest -f Auth/Dockerfile . # run from base folder
docker push zuhiddev.azurecr.io/auth:latest
